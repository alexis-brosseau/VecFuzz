...
def main() -> None:
	...
	parser.add_argument("--vocab-sizes", type=int, nargs="+", default=[5_000, 10_000, 20_000, 40_000, 60_000, 80_000, 100_000, 125_000, 150_000], help="Dictionary sizes to sweep.")
